    ...
    def __call__(self, data):
        if self.content_types:
            ...
            if missing_columns:
                ...
                raise ValidationError(
                    self.error_messages["missing_columns"], "missing_columns", params
                )
            ...
            if empty_rows:
                ...
                raise ValidationError(
                    self.error_messages["empty_rows"], "empty_rows", params
                )
            ...
            if invalid_phones_rows:
                ...
                raise ValidationError(
                    self.error_messages["invalid_phones_rows"],
                    "invalid_phones_rows",
                    params,
                )
            ...
            if duplicates:
                ...
                raise ValidationError(
                    self.error_messages["rows_w_duplicates"],
                    "rows_w_duplicates",
                    params,
                )
